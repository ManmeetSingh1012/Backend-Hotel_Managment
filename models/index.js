...
// GuestPendingPayment associations
GuestPendingPayment.belongsTo(Hotel, {
  foreignKey: "hotelId",
  as: "hotel",
});

Hotel.hasMany(GuestPendingPayment, {
  foreignKey: "hotelId",
  as: "pendingPayments",
});

// DailyBalanceSheet associations
DailyBalanceSheet.belongsTo(Hotel, {
  foreignKey: "hotelId",
  as: "hotel",
});

Hotel.hasMany(DailyBalanceSheet, {
  foreignKey: "hotelId",
  as: "balanceSheets",
});
